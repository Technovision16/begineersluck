...
<table width="100%" border=1 align="center" background="a.jpg"><tr><th><font face="Calibri" size="4">Book ID</th><th><font face="calibri" size="4">Book Name</th><th><font face="calibri" size="4">Author Name</th><th><font face="calibri" size="4">Edition</th><th>Publisher<font face="calibri" size="4"></th><th>ISBN No.<font face="calibri" size="4"></th></tr>   
<?php
...
if ($conn->connect_error) {
    ...
    if (isset ($_POST['bid']));
        ...
        $bname= $_POST['bname'];
        $aname= $_POST['aname'];
    $sql ="Select bid,bname,aname,edition,publisher,isbn from infoit where bid='$book_id' " or die("could not search");
